...
本来是打算着重写职场危机的，但前几天看到了「计算机之子」程劭非（winter）的文章，也就是在[第二届 FEDay 前端开发者大会](http://www.fequan.com/2016/){:target="_blank"}{:rel="external nofollow"}上的分享的补充版，《[一个前端的自我修养](http://taobaofed.org/blog/2016/03/23/the-growth-of-front-end/){:target="_blank"}{:rel="external nofollow"}》之后有些共鸣，再加上最近在职业发展上有点思想上的转变，所以这篇文章的主要内容就变成了讲述「一个前端的职业轨迹」。
